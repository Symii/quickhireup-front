...
.job-card:hover {
  ...
  box-shadow: 0 10px 30px rgba(255, 86, 102, 0.15);
}

.company-icon {
  background: rgba(255, 86, 102, 0.1);
  color: #ff5666;
  font-weight: bold;
  width: 48px;
  height: 48px;
...
.btn-gradient {
  background: linear-gradient(90deg, #ff5666, #ff2a44);
  color: white;
  border: none;
...
.btn-gradient:hover {
  background: linear-gradient(90deg, #e04353, #b2222f);
  color: white;
}
</style>
